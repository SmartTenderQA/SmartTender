...
Сформувати рахунок-фактуру(неідентифікований користувач)
    [Tags]  unidentified
    Перевірити що підказка містить текст  Сума до оплати має бути кратною
    Перевірити що підказка містить текст  Ваша компанія повинна пройти ідентифікацію
    Перевірити що на сторінці стільки типів оплати  1
    Перевірити що на сторінці є тип оплати  Сформувати рахунок-фактуру для оплати
