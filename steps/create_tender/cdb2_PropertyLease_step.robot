*** Settings ***
Library  ../../src/pages/sale/SPF/cdb2_PropertyLease_page/cdb2_PropertyLease_variables.py
...
Створити аукціон
	...
	Run Keyword  cdb2_PropertyLease_step.Заповнити "День старту електроного аукціону" ${site}
	cdb2_PropertyLease_step.Заповнити "Початкова ціна реалізації лоту"
	Run Keyword If  '${site}' == 'prod'
	...  cdb2_PropertyLease_step.Заповнити "Контактна особа"
	cdb2_PropertyLease_step.Заповнити "Предмет продажу"
	cdb2_PropertyLease_step.Заповнити "Позиції аукціону"
#    cdb2_PropertyLease_page.Очистити поле "Прийом пропозицій по"
	cdb2_PropertyLease_step.Заповнити "Гарантійний внесок"
    cdb2_PropertyLease_step.Заповнити "Умови договору аренди"
...
Завантажити локатори
	${edit_locators}  cdb2_PropertyLease_variables.get_edit_locators
	${view_locators}  cdb2_PropertyLease_variables.get_view_locators
	${data}  cdb2_PropertyLease_variables.get_data
...
Заповнити "День старту електроного аукціону" test
	...
	cdb2_PropertyLease_page.Заповнити auctionPeriod.startDate  ${startDate}
...
Заповнити "Початкова ціна реалізації лоту"
	cdb2_PropertyLease_step.Заповнити "Ціна"
	cdb2_PropertyLease_step.Заповнити "Мінімальний крок аукціону"


Заповнити "Ціна"
	${amount}  random_number  100000  100000000
	cdb2_PropertyLease_page.Заповнити value.amount  ${amount}
	Set To Dictionary  ${data['value']}  amount  ${amount}


Заповнити "Мінімальний крок аукціону"
	${minimal_step_percent}  random_number  1  5
	cdb2_PropertyLease_page.Заповнити minimalStep.amount  ${minimal_step_percent}
...
Заповнити "Предмет продажу"
	cdb2_PropertyLease_step.Заповнити "Загальна назва аукціону"
	cdb2_PropertyLease_step.Заповнити "Номер лоту в замовника"
	cdb2_PropertyLease_step.Заповнити "Детальний опис"


Заповнити "Загальна назва аукціону"
	${title}  create_sentence  5
	cdb2_PropertyLease_page.Заповнити title  [ТЕСТУВАННЯ] ${title}
...
Заповнити "Номер лоту в замовника"
	...
	cdb2_PropertyLease_page.Заповнити lotIdentifier  ${lotIdentifier}
	Set To Dictionary  ${data}  lotIdentifier  ${lotIdentifier}


Заповнити "Детальний опис"
	${description}  create_sentence  20
	cdb2_PropertyLease_page.Заповнити description  ${description}
	Set To Dictionary  ${data}  description  ${description}


Заповнити "Позиції аукціону"
	cdb2_PropertyLease_step.Заповнити "Найменування позиції"
	cdb2_PropertyLease_step.Заповнити "Кількість активів"
	cdb2_PropertyLease_step.Заповнити "Од. вим."
	cdb2_PropertyLease_step.Заповнити "Класифікація"
	cdb2_PropertyLease_step.Заповнити "Розташування об'єкту"


Заповнити "Найменування позиції"
	${description}  create_sentence  3
	cdb2_PropertyLease_page.Заповнити items.0.description  ${description}
	Set To Dictionary  ${data['items'][0]}  description  ${description}


Заповнити "Кількість активів"
	${quantity}  random_number  1  1000
	cdb2_PropertyLease_page.Заповнити items.0.quantity  ${quantity}
	Set To Dictionary  ${data['items'][0]}  quantity  ${quantity}


Заповнити "Од. вим."
	${name}  cdb2_PropertyLease_page.Заповнити items.0.unit.name
	Set To Dictionary  ${data['items'][0]['unit']}  name  ${name}


Заповнити "Класифікація"
	${classification}  cdb2_PropertyLease_page.Заповнити items.0.classification
...
Заповнити "Розташування об'єкту"
	cdb2_PropertyLease_step.Заповнити "Індекс"
	cdb2_PropertyLease_step.Заповнити "Вулиця"
	cdb2_PropertyLease_step.Заповнити "Місто"


Заповнити "Індекс"
	${postalCode}  random_number  10000  99999
	cdb2_PropertyLease_page.Заповнити items.0.address.postalCode  ${postalCode}
...
Заповнити "Вулиця"
	...
	cdb2_PropertyLease_page.Заповнити items.0.address.streetAddress  ${streetAddress}
...
Заповнити "Місто"
	...
	${locality}  ${region}  ${countryName}  cdb2_PropertyLease_page.Заповнити items.0.address.locality
...
Заповнити "Гарантійний внесок"
	...
	cdb2_PropertyLease_page.Заповнити guarantee.amount  ${guarantee_amount_percent}


Заповнити "Умови договору аренди"
    ${leaseDuration}  random_number  1  20
    Відкрити вкладку Умови договору аренди
    cdb2_PropertyLease_page.Заповнити contractTerms.leaseTerms.leaseDuration  ${leaseDuration}
