...
view_locators = {
	...
	"auctionParameters": {
		"dutchSteps": u"//*[contains(@class,'ivu-row') and contains(.,'Кількість кроків')]//*[contains(@class,'second')]",
	},
	"guarantee": {
		...
		[
			{
				...
				"unit": {
					"name": u"(//*[contains(@class,'ivu-row') and contains(.,'Кількість')]//*[contains(@class,'second')])[last()]"
				},
				"quantity": u"(//*[contains(@class,'ivu-row') and contains(.,'Кількість')]//*[contains(@class,'second')])[last()]",
				"address": {
