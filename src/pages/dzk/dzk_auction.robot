...
Перевірити всі обов'язкові поля в цбд
	compare_data.Порівняти введені дані з даними в ЦБД  ['lotIdentifier']
	compare_data.Порівняти введені дані з даними в ЦБД  ['title']
	compare_data.Порівняти введені дані з даними в ЦБД  ['description']
	compare_data.Порівняти введені дані з даними в ЦБД  ['lotHolder']['identifier']['legalName']
	compare_data.Порівняти введені дані з даними в ЦБД  ['lotHolder']['identifier']['id']
	compare_data.Порівняти введені дані з даними в ЦБД  ['lotHolder']['address']['postalCode']
	compare_data.Порівняти введені дані з даними в ЦБД  ['lotHolder']['address']['region']
	compare_data.Порівняти введені дані з даними в ЦБД  ['lotHolder']['address']['locality']
	compare_data.Порівняти введені дані з даними в ЦБД  ['lotHolder']['address']['streetAddress']
	compare_data.Порівняти введені дані з даними в ЦБД  ['lotHolder']['contactPoint']['name']
	compare_data.Порівняти введені дані з даними в ЦБД  ['lotHolder']['contactPoint']['email']
	#todo
	#compare_data.Порівняти введені дані з даними в ЦБД  ['auctionPeriod']['startDate']
	#
	Run Keyword And Ignore Error  compare_data.Порівняти введені дані з даними в ЦБД  ['tenderAttempts']
	compare_data.Порівняти введені дані з даними в ЦБД  ['minNumberOfQualifiedBids']
	compare_data.Порівняти введені дані з даними в ЦБД  ['contractTerms']['leaseTerms']['leaseDuration']
	compare_data.Порівняти введені дані з даними в ЦБД  ['value']['amount']
	compare_data.Порівняти введені дані з даними в ЦБД  ['minimalStep']['amount']
	compare_data.Порівняти введені дані з даними в ЦБД  ['guarantee']['amount']
	compare_data.Порівняти введені дані з даними в ЦБД  ['budgetSpent']['amount']
	compare_data.Порівняти введені дані з даними в ЦБД  ['registrationFee']['amount']
	compare_data.Порівняти введені дані з даними в ЦБД  ['bankAccount']['bankName']
	compare_data.Порівняти введені дані з даними в ЦБД  ['bankAccount']['accountIdentification'][0]['description']
	: FOR  ${i}  IN RANGE  0  9
    \  compare_data.Порівняти введені дані з даними в ЦБД  ['bankAccount']['accountIdentification'][${i}]['id']
	compare_data.Порівняти введені дані з даними в ЦБД  ['items'][0]['description']
	compare_data.Порівняти введені дані з даними в ЦБД  ['items'][0]['additionalClassifications'][1]['id']
	#todo nuzhno dodelat` classificatsii
	...
	compare_data.Порівняти введені дані з даними в ЦБД  ['items'][0]['additionalClassifications'][0]['id']
	compare_data.Порівняти введені дані з даними в ЦБД  ['items'][0]['additionalClassifications'][0]['description']
...
Перевірити відображення всіх обов'язкових полів на сторінці аукціону
	...
	compare_data.Порівняти відображені дані з даними в ЦБД  ['lotIdentifier']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['auctionID']
	#todo hz 4to tut delat`
	#compare_data.Порівняти відображені дані з даними в ЦБД  ['tenderAttempts']
	#
	compare_data.Порівняти відображені дані з даними в ЦБД  ['description']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['rectificationPeriod']['startDate']
...
#	#
	...
	compare_data.Порівняти відображені дані з даними в ЦБД  ['registrationFee']['amount']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['minNumberOfQualifiedBids']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['contractTerms']['leaseTerms']['leaseDuration']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['procuringEntity']['identifier']['legalName']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['procuringEntity']['identifier']['id']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['procuringEntity']['contactPoint']['email']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['procuringEntity']['contactPoint']['name']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['procuringEntity']['contactPoint']['telephone']
#	### todo tut bug s otobrazheniiem
#	compare_data.Порівняти відображені дані з даними в ЦБД  ['procuringEntity']['address']['countryName']
#	compare_data.Порівняти відображені дані з даними в ЦБД  ['procuringEntity']['address']['streetAddress']
#	compare_data.Порівняти відображені дані з даними в ЦБД  ['procuringEntity']['address']['region']
#	compare_data.Порівняти відображені дані з даними в ЦБД  ['procuringEntity']['address']['locality']
#	###
	compare_data.Порівняти відображені дані з даними в ЦБД  ['bankAccount']['bankName']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['bankAccount']['accountIdentification'][0]['description']
	: FOR  ${i}  IN RANGE  0  9
    \  compare_data.Порівняти відображені дані з даними в ЦБД  ['bankAccount']['accountIdentification'][${i}]['id']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['lotHolder']['identifier']['legalName']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['lotHolder']['identifier']['id']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['lotHolder']['identifier']['scheme']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['lotHolder']['address']['postalCode']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['lotHolder']['address']['region']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['lotHolder']['address']['locality']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['lotHolder']['address']['streetAddress']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['lotHolder']['contactPoint']['name']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['lotHolder']['contactPoint']['email']
	...
	#todo tut trudnosti s perevodom
	#compare_data.Порівняти відображені дані з даними в ЦБД  ['items'][0]['additionalClassifications'][0]['scheme']
	#
	compare_data.Порівняти відображені дані з даними в ЦБД  ['items'][0]['additionalClassifications'][0]['scheme']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['items'][0]['additionalClassifications'][0]['id']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['items'][0]['additionalClassifications'][0]['description']
	compare_data.Порівняти відображені дані з даними в ЦБД  ['items'][0]['additionalClassifications'][1]['id']
